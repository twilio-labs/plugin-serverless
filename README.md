...
_See code: [src/commands/serverless/activate.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/activate.js)_
...
_See code: [src/commands/serverless/deploy.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/deploy.js)_
...
_See code: [src/commands/serverless/init.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/init.js)_
...
_See code: [src/commands/serverless/list.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/list.js)_
...
_See code: [src/commands/serverless/list-templates.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/list-templates.js)_
...
_See code: [src/commands/serverless/new.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/new.js)_
...
_See code: [src/commands/serverless/start.js](https://github.com/twilio-labs/plugin-serverless/blob/v1.1.3/src/commands/serverless/start.js)_
<!-- commandsstop -->
